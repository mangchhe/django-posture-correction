...
class EdusDB(models.Model): # 학습 디비 클래스
    ...
    # video_id = models.ForeignKey(VideosDB, on_delete = models.CASCADE)  # 영상 번호, models.CASCADE : 주키 삭제 시 외래키 같이 삭제(연쇄 삭제)
    # user_id = models.ForeignKey(UsersDB, on_delete = models.CASCADE)    # 사용자 번호
